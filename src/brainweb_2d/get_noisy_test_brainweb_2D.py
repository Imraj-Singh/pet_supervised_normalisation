...
if __name__ == "__main__":
    ...
    for tumour in bool_tumour:
        ...
        if tumour:
            dataset = BrainWebClean(path_to_files="E:/projects/pet_score_model/src/brainweb_2d/clean/clean_test_tumour.pt")
        else:
            dataset = BrainWebClean(path_to_files="E:/projects/pet_score_model/src/brainweb_2d/clean/clean_test.pt")

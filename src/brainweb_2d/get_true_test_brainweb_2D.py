...
if __name__=="__main__":
    ...
    for tumour in bool_tumour:
        ...
        if tumour:
            ...
            torch.save(recon_dict, "E:/projects/pet_score_model/src/brainweb_2d/clean/clean_test_tumour.pt")
        else:
            recon_dict = {'clean_measurements': clean_data_pts, 'mu': mu_ref_pts, 'reference': image_ref_pts, 'mri': mri_ref_pts}
            torch.save(recon_dict, "E:/projects/pet_score_model/src/brainweb_2d/clean/clean_test.pt")